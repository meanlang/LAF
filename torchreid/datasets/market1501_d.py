...
class Market1501_D(BaseImageDataset):
    """
    Market1501
    ...
    def _get_from_file(self, root, dir_path, fn):
        ...
        with open(fn, 'r') as f:
            ...
            for line in f.readlines()[1:]:
                ...
                if 'distractors' in image_path:
                    image_path = osp.join(root, image_path)
                else:
                    image_path = osp.join(dir_path, image_path)

                pid, cid = map(int, (pid, cid))

                dataset.append((image_path, pid, cid))
