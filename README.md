...
python train.py -s market1501 -t market1501 \
    ...
    --margin 1.2 \
    --train-batch-size 64 \[README_Training_and_Testing_Guides.md](README_Training_and_Testing_Guides.md)
    --height 384 \
    --width 128 \
...
## Branches
 ...
 + you can add thr branches you need as needed, You should add the branch program to the torchreid.components.branches.py program
